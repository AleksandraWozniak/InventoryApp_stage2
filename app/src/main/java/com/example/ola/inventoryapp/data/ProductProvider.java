...
public class ProductProvider extends ContentProvider {
    ...
    private Uri insertProduct(Uri uri, ContentValues values) {
        ...
        if (author == null) {
            throw new IllegalArgumentException("Product requires an author");
        }
        Integer cover = values.getAsInteger(ProductEntry.COLUMN_PRODUCT_COVER);
        if (cover == null || !ProductEntry.isValidCover(cover)) {
            throw new IllegalArgumentException("Product requires cover");
        }
    ...
    private int updateProduct(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(ProductEntry.COLUMN_PRODUCT_COVER)) {
            Integer cover = values.getAsInteger(ProductEntry.COLUMN_PRODUCT_COVER);
            if (cover == null || !ProductEntry.isValidCover(cover)) {
                throw new IllegalArgumentException("Product requires cover");
            }
